      ...
      <div className="grid md:grid-cols-2 gap-10 max-w-6xl mx-auto items-center">
        ...
        <div className="grid grid-cols-2 gap-4">
          ...
          <div className="col-span-2">
            <img
              src="src\assets\images\pexels-ron-lach-10646410.jpg"
              alt="Students image"
          ...
          <div className="col-span-2">
            <img
              src="src\assets\images\staff-meeting-group-young-modern-people-smart-casual-wear-discussing-something-while-working-creative-office-business-time.jpg"
              alt="staffs image"
              className="rounded-xl shadow-xl w-full object-cover h-64"
            />
          </div>
